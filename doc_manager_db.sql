...
--
CREATE DATABASE IF NOT EXISTS `Document_Manager` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
...
CREATE TABLE `File` (
  `idFile` int NOT NULL,
  `nameUser` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `fileTag` varchar(45) NOT NULL,
  `fileName` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `filePath` varchar(64) NOT NULL,
  `fileType` varchar(32) CHARACTER SET utf16 COLLATE utf16_general_ci NOT NULL,
  `fileContent` mediumblob NOT NULL,
  `dateReceived` date DEFAULT NULL,
  `dateFileUpload` datetime NOT NULL,
  `dateLastViewed` timestamp NOT NULL,
  `fileStatus` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- --------------------------------------------------------

--
-- Table structure for table `File Log`
--

CREATE TABLE `File Log` (
  `idLog` int NOT NULL,
  `filename` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `sid` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `uid` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `date` datetime NOT NULL,
  `message` varchar(128) NOT NULL,
  `errorStatus` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- --------------------------------------------------------

--
-- Table structure for table `Session Log`
--

CREATE TABLE `Session Log` (
  `idLog` int NOT NULL,
  `sid` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `uid` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `date` datetime NOT NULL,
...
ALTER TABLE `File`
  ...
  ADD KEY `userID_idx` (`nameUser`);

--
-- Indexes for table `File Log`
--
ALTER TABLE `File Log`
  ADD KEY `idLog` (`idLog`);

--
-- Indexes for table `Session Log`
--
ALTER TABLE `Session Log`
  ADD KEY `idLog` (`idLog`);
...
--
-- AUTO_INCREMENT for table `File Log`
--
ALTER TABLE `File Log`
  MODIFY `idLog` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `Session Log`
--
ALTER TABLE `Session Log`
  MODIFY `idLog` int NOT NULL AUTO_INCREMENT;
